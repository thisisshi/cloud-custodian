...
from c7n_kube.actions.core import DeleteResource, PatchResource, EventPatchAction
...
SHARED_ACTIONS = (
    DeleteResource, LabelAction, PatchResource, EventLabelAction,
    AutoLabelUser, EventPatchAction)
